...
parser.add_argument('--data_path', type=str, default='./datasets/dogs/')
...
train_dataset = datasets.ImageFolder(
    os.path.join(args.data_path, 'DogsTrain'),
    transforms.Compose([
...
test_dataset = datasets.ImageFolder(
    os.path.join(args.data_path, 'DogsTest'),
    transforms.Compose([
        transforms.Resize(size=(img_size, img_size)),
        transforms.ToTensor(),
        normalize,
...
final_cm_path = output_dir / 'dogs_confusion_matrix.png'
